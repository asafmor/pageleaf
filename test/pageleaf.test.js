...
test('the generated template uses theme-local colors for navigation scrollbars at every viewport width', async () => {
  ...
  assert.match(template, /\.primary::-webkit-scrollbar-button:single-button,\.primary::-webkit-scrollbar-button:horizontal:decrement,\.primary::-webkit-scrollbar-button:horizontal:increment\{display:none!important;width:0;height:0\}/);
